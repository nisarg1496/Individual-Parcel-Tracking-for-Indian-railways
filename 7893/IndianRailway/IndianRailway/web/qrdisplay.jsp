            ...
            <div class="col-md-6" >
                <div class="content-box-large">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="printableArea" style="float: center">

                            <%                    int no_of_pkg = Integer.parseInt(request.getParameter("no_of_pkg"));

                                for (int i = 0; i <= no_of_pkg; i++) {
                                    try {
                                        ...
                                        String query1 = "SELECT * FROM package_details WHERE pkg_id='" + i + request.getParameter("packageId") + "'";
                                        System.out.println(query1);
                                        ResultSet rs = stmt.executeQuery(query1);

                                        int sender_cid = 0, receiver_cid = 0;
                                        int total_cost = 0;
                                        String creation_date = null, src_station_code = null, dest_station_code = null, pkg_type = null;
                                        String scale_transport_type = null;
                                        while (rs.next()) {
                                            ...
                                            scale_transport_type = rs.getString("scale_transport_type");
                                        }
                            ...
                            <div class="invoice-box">
                                <table cellpadding="0" cellspacing="0">
                                    <tr class="top">
                                        <td colspan="2">
                                            <table>
                                                <tr>
                                                    <td class="title">
                                                        <image  src="/IndianRailway/QRcodeServlet?id=<%=i + request.getParameter("packageId")%>" width="200" height="200"></image>
                                                    </td>
                                                    <td>
                                                        <b><h1><%= src_station_code%> - <%= dest_station_code%></h1></b>
                                                        <b>Package ID: <%= i + pkg_id%></b><br>
                                    ...
                                    <tr class="details">
                                        <td>
                                            Package Type:<br>
                                            Scale Transport Type:
                                        </td>

                                        <td>
                                            <%= pkg_type%><br>
                                            <%= scale_transport_type%>
                                        </td>
                                    </tr>
