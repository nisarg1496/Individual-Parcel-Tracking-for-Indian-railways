...
<html>
    ...
    <body class="login-bg">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Logo -->
                        <div class="logo">
                            <h1 style="color:white">Indian Railways Parcel Management System</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="page-content container">
            <center><image src="\IndianRailway\ir_logo.png" width="200" height="200" alt="IR logo"> </image>
            </center>
            <div class="row">
                        ...
                        <div class="box">
                            <div class="content-wrap">
                                ...
                                <form id="loginForm" action="HomeServlet" method="post">
                                    ...
                                    <input  class="form-control" id="password" type="password" name="password" value="shraddha12345" placeholder="Password">
