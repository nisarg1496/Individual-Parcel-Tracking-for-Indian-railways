...
// See if the input data validates OK
            ...
            function saveNextForm() {
                document.getElementById("display_dest_hidden").value = document.getElementById("display_dest_tb").value;


                //alert("Hello");
                var hiddenVal = document.getElementById("display_dest_hidden").value;
                //hiddenVal = ",";//document.getElementById("display_dest_tb").value;
                //alert(hiddenVal);
                var display_dest_tb = document.getElementById("display_dest_tb").value;
                var array = display_dest_tb.split(" ");
                hiddenVal = "," + array.join();
                hiddenVal = hiddenVal.substring(1);

                document.getElementById("display_dest_hidden").value = hiddenVal;
                //alert(hiddenVal);
            ...
            function saveDest() {
                var dest_value = document.getElementById("destcode").value;//dest drop dwn

                var display_dest_tb = document.getElementById("display_dest_tb");
                dest_value = dest_value.split("(")[0];
                //display_dest_tb.value = display_dest_tb.value + "," + dest_value;
                display_dest_tb.value = display_dest_tb.value + " " + dest_value;

                //alert(document.getElementById("display_dest_hidden").value);
            }

            function disableTB() {
                document.getElementById("display_dest_tb").disabled = true;
                document.getElementById("save_button").disabled = true;

            }

            function enableTB() {
                document.getElementById("display_dest_tb").disabled = false;
                document.getElementById("save_button").disabled = false;
            }

            function visibleRoute() {
                document.getElementById("get_route_help").style.visibility = "visible";
                document.getElementById("get_route_help").innerHTML = "shraddha";
        ...
        <div class="page-content">
            <div class="row">
                ...
                <%                    try {
                        ...
                        String url = "jdbc:mysql://192.168.1.100/indianrail";
                            ...
                            <form id="collectParcelForm" action='CollectParcelServlet' method="post">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="sname" type="text" name="sname" placeholder="sender name" value="Sherlock">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="sphone" type="text" name="sphone" placeholder="sender phone" value="7738722506">
                                        <span id="sphone_help">
                                    </div>

                                    <div class="form-group">
                                        <label>Email :</label>
                                        <input class="form-control" id="semail" type="email" name="semail" placeholder="sender email" value="sherlock@gmail.com">
                                        <span id="semail_help">
                                    </div>

                                    <div class="form-group">
                                        <span class="compulsary">* </span><label>Address :</label>
                                        <input class="form-control" id="saddress" type="text" name="saddress" placeholder="sender address" value="221-B, Baker Street">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <span class="compulsary">* </span><label>Name :</label>
                                        <input class="form-control" id="rname" type="text" name="rname" placeholder="receiver name" value="Watson">
                                    ...
                                    <div class="form-group">
                                        <span class="compulsary">* </span><label>Phone :</label>
                                        <input class="form-control" id="rphone" type="text" name="rphone" placeholder="receiver phone" value="9773919892">
                                        <span id="rphone_help">
                                    </div>

                                    <div class="form-group">
                                        <label>Email :</label>
                                        <input class="form-control" id="remail" type="email" name="remail" placeholder="receiver email" value="watson@gmail.com">
                                        <span id="remail_help">
                                    </div>

                                    <div class="form-group">
                                        <span class="compulsary">* </span><label>Address :</label>
                                        <input class="form-control" id="raddress" type="text" name="raddress" placeholder="receiver address" value="221-C, Caker Street">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <span class="compulsary">* </span><label>Package Weight/Freight :</label>
                                        <input class="form-control" id="pkg_weight" type="text" name="pkg_weight" placeholder="package weight" value="1400">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="pkg_type" type="text" name="pkg_type" placeholder="package type" value="fragile">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="destcode" type="text" name="destcode" placeholder="destination station code" onchange="saveDest()">
                                            <option></option>
                                            <%  rs.beforeFirst();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="height:100px" class="form-control" id="display_dest_tb" type="text" name="display_dest_tb" ></input>
                                        <input style="float: right" type="button" value="Edit" onclick="enableTB()"></input>
                                        <input style="float: right" type="button" value="Save changes" id="save_button" onclick="disableTB()"></input>

                                        <!--                                        <label style="height:100px" class="form-control" id="display_dest" name="display_dest"><input style="float: right" type="button" value="Edit"></input></label>-->
                                    </div>
                                    ...
                                    <input type="hidden" id="display_dest_hidden" name="display_dest_hidden"></input>
