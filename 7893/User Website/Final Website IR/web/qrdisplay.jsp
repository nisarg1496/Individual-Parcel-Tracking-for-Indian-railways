                                        ...
                                        <tr class="top">
                                            <td colspan="2">
                                                <table>
                                                    <tr>
                                                        <td class="title">
                                                            <% System.out.println("QRDISPLAY PAGE: "+request.getParameter("pkgid")); %>
                                                            <image  src="QRcodeServlet?id=<%=request.getParameter("pkgid")%>" width="200" height="200">
                                                        </td>
                                                        ...
                                                        <%
                                                            try {
                                                                ...
                                                                String pkg_id = request.getParameter("pkgid");
                                                                System.out.println(pkg_id);
                                                                String query1 = "SELECT * FROM package_details WHERE pkg_id='" + request.getParameter("pkgid") + "'";
                                                        ...
                                                        <td>
                                                            <b><h3><%= src_station_code%> - <%= dest_station_code%></h3></b>
                                                            <b>Package ID: <%=  pkg_id%></b><br>
