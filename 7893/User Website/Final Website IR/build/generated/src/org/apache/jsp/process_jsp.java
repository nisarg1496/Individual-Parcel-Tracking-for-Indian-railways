    ...
    try {
      ...
      out.write("        ");
           ...
           try {
                ...
                //Connection con = DriverManager.getConnection("jdbc:mysql://192.168.43.33/indianrail", "thompson", "root");
                ...
                rs = stmt.executeQuery("select distinct(station_name),time from package_location where pkm_id=(select pkm_id from package_train_mapping where pkg_id = '" + pkgid + "') order by time DESC;");
                ...
                rs1 = stmt.executeQuery("select load_unload_status,unload_time,train_no from package_train_mapping where pkg_id = '" + pkgid + "'");
      ...
      out.write("                <p class=\"text-center w3layouts w3 w3l agileits agileinfo\">Real time package tracking like never before.</p>\n");
      out.write("            </div>\n");
      out.write("        </section>\n");
      out.write("        <!-- /banner section -->\n");
      ...
      out.write("                <p class=\"text-center wthree w3-agileits agileits-w3layouts agile w3-agile\">Animated representation of the real time status of your package.</p>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"container\">\n");
...
out.println(pkgid);
      out.write("</h2>\n");
      out.write("                        <form>\n");
      out.write("                            <h4 class=\"color\"><b><a href=\"bill.html\">View Bill</a></b></h4>\n");
      out.write("                        </form>\n");
      out.write("                    </div>\n");
...
if(status.trim().equalsIgnoreCase("P")){
      out.write("<p>Status : <span> Processing Order</span></p>\n");
      out.write("                            ");
}else if(status.trim().equalsIgnoreCase("L")){
      out.write("<p>Status :<span> In Transit</span></p>\n");
      out.write("                            ");
}else if(status.trim().equalsIgnoreCase("U")){
      out.write("<p>Status :<span> Product Delivered</span></p>");
}
      out.write("\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"content2-header1\">\n");
...
if(status.trim().equalsIgnoreCase("U")){
      ...
      out.write("                <p class=\"text-center\">Check real time status of your package with the most recent update on top.</p>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"container\">\n");
...
out.println("Your package has reached the destination station");
      out.write("</h4>\n");
...
out.println(unloadtime);
      ...
      out.write("\n");
      out.write("                                                    <h4 class=\"text-center\">");
out.println("Your package has reached at "+locations.get(jj)+" station.");
      out.write("</h4>\n");
      out.write("                                                    <div class=\"clearfix\"></div>\n");
      out.write("                                                </td>\n");
      out.write("                                                <td><h4 class=\"text-center\">");
...
out.println(createtime);
      ...
      out.write("});\n");
      out.write("        </script>\n");
      out.write("        <script src=\"http://maps.google.com/maps/api/js?key=AIzaSyBVi14_ZTj1E6qe9l311HpdukC5-dAb4Bw&callback=initmap\" \n");
      out.write("           type=\"text/javascript\"></script>\n");
      out.write("        <div id=\"map\" style=\"width: 400px; height: 300px; align: center\"></div>\n");
      out.write("         <script type=\"text/javascript\"> \n");
      out.write("\n");
      out.write("   var address = 'Udaipur, Railway Station';\n");
      out.write("\n");
      ...
      out.write("      }\n");
      out.write("      else {\n");
      out.write("         // Google couldn't geocode this request. Handle appropriately.\n");
      out.write("      }\n");
      out.write("   });\n");
      out.write("\n");
      out.write("   </script> \n");
